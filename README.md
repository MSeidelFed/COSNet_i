...
## Introduction
COSNet<sub>i</sub> is a collection of scripts that allow random walk based selection of spatially coherent neighborhoods of proteins of a multiprotein complex in order to test whether these neighborhoods characterize a region within the complex that is significantly modified by any experimental procedure. The methodology has been detailed in [10.3390/ijms22116160](https://doi.org/10.3390/ijms22116160) and [10.1186/s12859-021-04510-z](https://doi.org/10.1186/s12859-021-04510-z) publications.
